...
/**
 * This class has been extracted from the MethodUtils provided on the Apache
...
public class MethodUtils {
     ...
     * compatible parameters. Compatible parameters mean that every method
     * parameter is assignable from the given parameters. In other words, it
     * finds a method with the given name that will take the parameters
     * given.<p>
     *
     ...
     * <code>Boolean</code> will match a primitive
    ...
    public static Method getMatchingAccessibleMethod(Class cls,
        ...
        try {
            ...
            org.jdto.util.MemberUtils.setAccessibleWorkaround(method);
            return method;
        } catch (NoSuchMethodException e) { /*
             * SWALLOW
             */
