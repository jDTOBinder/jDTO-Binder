...
\begin{itemize}
\item Mergers API modified so now mergers can take multiple parameters instead of one, this provides a clearer and more extensible API.
\item Improved existing mergers to take basic advantage of this new feature (more will come in the future).
\item New PropertyCollection merger, this helps converting a collection of a complex object into a collection of one of its attributes.
\end{itemize}

Issues solved:
\begin{itemize}
\item Migrated current mergers to accept multiple parameters.
\item Added basic validation to existing mergers.
\item Improved project pom configuration.
\item Improved javadoc.
\end{itemize}
...
\begin{xml}
     <repositories>
        <repository>
            ...
            <name>jdto</name>
            <url>http://maven2.juancavallotti.com/</url>
...
The following snipped demonstrates how you can configure a constructor to be used by the \JDTO framework:
