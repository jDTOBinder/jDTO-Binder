...
\newcommand{\JDV}{1.0-BETA1\xspace}
...
\begin{itemize}
\item Added new ToStringMerger.
\item Added new EnumMerger.
\item Added new CloneMerger.
\end{itemize}

Issues solved:
\begin{itemize}
\item Fixed little mistakes on documentation.
\end{itemize}
